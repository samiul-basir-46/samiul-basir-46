...
- 🎯 Goal: To become a professional mobile app developer specializing in Flutter  
- 🏪 Published apps on both **Apple App Store** and **Google Play Store**  
- 💬 Ask me about **Flutter, Dart, Firebase, Provider, API integration**
...
- **Others:** REST API, JSON, Responsive UI Design, In-App Purchases (RevenueCat), Apple App Store & Google Play deployment
...
|----------|--------------|------|
| 🌦️ **Weather App** | Real-time weather info using OpenWeather API | Flutter, Provider, REST API |
| 🛒 **Grocery App** | Product list, details & cart using API | Flutter, Provider |
| 📝 **Notepad App** | Firebase-based note app with CRUD | Flutter, Firebase |
...
![Samiul's GitHub Stats](https://github-readme-stats.vercel.app/api?username=samiul-basir-46&show_icons=true&theme=tokyonight&hide_border=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=samiul-basir-46&layout=compact&theme=tokyonight&hide_border=true)

---

### 🏆 **Achievements**
- 📦 Published **3+ apps** on App Store & Play Store  
- 🌍 Apps available in **170+ countries**  
- 💳 Integrated **subscription & In-App Purchase** systems  
- 🔐 Implemented **Google Sign-In, Apple Sign-In, Firebase Auth** in production apps  
